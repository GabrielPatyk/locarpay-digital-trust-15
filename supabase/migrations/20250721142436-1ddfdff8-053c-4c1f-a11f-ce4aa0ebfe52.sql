-- Primeiro alterar o valor padrão da coluna status_contrato
ALTER TABLE public.contratos_fianca 
ALTER COLUMN status_contrato DROP DEFAULT;
...
USING 'gerando_link'::public.status_contrato;

-- Definir novo valor padrão
ALTER TABLE public.contratos_fianca 
ALTER COLUMN status_contrato SET DEFAULT 'gerando_link'::public.status_contrato;

-- Adicionar colunas do inquilino
ALTER TABLE public.contratos_fianca 
