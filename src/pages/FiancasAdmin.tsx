            ...
            <div className="w-full overflow-x-auto">
              <div className="min-w-[800px]">
                <Table className="w-full">
                  <TableHeader>
                    <TableRow>
                      <TableHead className="w-[150px] px-3 py-2 text-xs">Inquilino</TableHead>
                      <TableHead className="w-[150px] px-3 py-2 text-xs">Imobiliária</TableHead>
                      <TableHead className="w-[180px] px-3 py-2 text-xs">Imóvel</TableHead>
                      <TableHead className="w-[100px] px-3 py-2 text-xs">Valor Fiança</TableHead>
                      <TableHead className="w-[120px] px-3 py-2 text-xs">Status</TableHead>
