            ...
            {['pagamento_disponivel', 'comprovante_enviado', 'ativa'].includes(fianca.status_fianca) && (
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <p className="text-gray-600"><strong>Situação:</strong> {fianca.situacao_pagamento || 'Pendente'}</p>
                    <p className="text-gray-600"><strong>Atualizado em:</strong> {fianca.data_atualizacao_pagamento ? new Date(fianca.data_atualizacao_pagamento).toLocaleDateString('pt-BR') : new Date(fianca.data_atualizacao).toLocaleDateString('pt-BR')}</p>
                  </div>
                </div>
              </div>
            )}
