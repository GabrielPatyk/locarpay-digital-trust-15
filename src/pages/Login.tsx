...
const Login = () => {
  ...
  const [unverifiedUserData, setUnverifiedUserData] = useState<{ email: string; name: string } | null>(null);
  ...
  return (
    <div className="min-h-screen w-full flex">
      ...
      {showVerificationModal && unverifiedUserData && (
        <EmailVerificationModal
          isOpen={showVerificationModal}
          onClose={() => setShowVerificationModal(false)}
          userEmail={unverifiedUserData.email}
